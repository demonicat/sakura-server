...
static constexpr auto STATUS_SERVER_NAME = "Sakura Server";
static constexpr auto STATUS_SERVER_VERSION = "0.0.1 — tfs1.4.1";
static constexpr auto STATUS_SERVER_DEVELOPERS = "demonicat";
